...
public class PartidaProfile : Profile
{
    public PartidaProfile()
    {
        ...
        CreateMap<Partida, PartidaMapaDTO>()
        .ForMember(
        dest => dest.estructuras,
        opt => opt.MapFrom(src => src.EstructuraMapa)
    );
        ...
        //    .ForMember(
        //        dto => dto.Energia,
        //        opt => opt.MapFrom(dominio => dominio.Recursos == null ? 0 : dominio.Recursos.Energia)
        //    )
        //    .ForMember(
        //        dto => dto.Felicidad, // Asumo que 'Felicidad' también está en Recursos
        //        opt => opt.MapFrom(dominio => dominio.Recursos == null ? 0 : dominio.Recursos.Felicidad)
        //    )
        //    .ForMember(
        //        dto => dto.Contaminacion,
        //        opt => opt.MapFrom(dominio => dominio.Recursos == null ? 0 : dominio.Recursos.Contaminacion)
        //    )
        //    .ForMember(
        //        dto => dto.EcoCoins,
        //        opt => opt.MapFrom(dominio => dominio.Recursos == null ? 0 : dominio.Recursos.EcoCoins)
        //    )
